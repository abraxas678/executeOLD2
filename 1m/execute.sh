...
mkdir $HOME/tmp/$ts
cd $HOME/tmp/$ts
curl -L http://execute.yyps.de -o execute.sh
chmod +x execute.sh
/home/abraxas/bin/runitor -every=0 -api-url=https://hc-ping.com -slug=execute_script -ping-key=o4zFWbG--a472NL8pc39jQ -- /bin/bash /home/abraxas/tmp/$ts/execute.sh
